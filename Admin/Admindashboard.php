    ...
    <div class="container-fluid">
        <div class="row justify-content-between align-content-center align-items-center">
            <div class="col-md-6 px-5">
                ...
                <p class="mt-1 lead" style="margin-left:10%;">Welcome to the Admin Dashboard. This central hub provides access to the Admin Panel for system management,
                    allows you to track user payment statuses, and offers a comprehensive view of all incoming orders</p>

                <p class="mt-1 lead" style="margin-left:10%;"> 1. Admin Panel <br> 2. Payment Status <br> 3. User Details <br> 4. Contact US</p>
